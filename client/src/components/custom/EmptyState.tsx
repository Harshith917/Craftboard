...
const Illustrations = {
  projects: (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="98" cy="28" r="14" fill="#E5E7EB" stroke="#D1D5DB" strokeWidth="1.5" />
      <path d="M98 22v12M92 28h12" stroke="#525252" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  ...
  requests: (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="36" y="56" width="20" height="20" rx="4" fill="#E5E7EB" stroke="#D1D5DB" strokeWidth="1.5" />
      <path d="M46 62v8M42 66h8" stroke="#525252" strokeWidth="1.5" strokeLinecap="round" />
      <rect x="64" y="56" width="20" height="20" rx="4" fill="#EDEDED" stroke="#C7C7C7" strokeWidth="1.5" />
      <path d="M74 62v8M70 66h8" stroke="#525252" strokeWidth="1.5" strokeLinecap="round" />
  ...
  members: (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="96" cy="36" r="10" fill="#E5E7EB" stroke="#D1D5DB" strokeWidth="1.5" />
      <path d="M96 32v8M92 36h8" stroke="#525252" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  ...
  search: (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="94" cy="40" r="8" fill="#E5E7EB" stroke="#D1D5DB" strokeWidth="1.5" opacity="0.8" />
      <path d="M94 37v6M91 40h6" stroke="#525252" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  ...
  notifications: (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="80" cy="40" r="8" fill="#E5E7EB" stroke="#D1D5DB" strokeWidth="1.5" />
      <path d="M80 37v6M77 40h6" stroke="#525252" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  ...
  pages: (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="88" cy="28" r="12" fill="#E5E7EB" stroke="#D1D5DB" strokeWidth="1.5" />
      <path d="M88 24v8M84 28h8" stroke="#525252" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  ...
  generic: (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="60" cy="56" r="14" fill="#E5E7EB" stroke="#D1D5DB" strokeWidth="1.5" />
      <path d="M60 50v12M54 56h12" stroke="#525252" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
};
...
function EmptyStateAction({ action, className }: { action: ActionButton; className?: string }) {
  const base =
    action.variant === "secondary"
      ? "inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-muted-foreground bg-card border border-border rounded-lg hover:bg-muted hover:text-foreground transition-colors"
      : "inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-primary-foreground bg-primary rounded-lg hover:opacity-90 transition-opacity";
