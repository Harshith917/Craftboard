...
const FEATURES = [
  ...
  { icon: Shield, title: "Role-based Access", desc: "Granular permissions â€” owner, editor, and viewer roles for every project." },
  ...
  { icon: Pen, title: "Canvas Editor", desc: "Rectangles, circles, text, frames, stars, arrows â€” a full shape library." },
  ...
  { icon: Bell, title: "Notifications", desc: "Access requests, role changes, and invites â€” stay informed." },
  { icon: Image, title: "Asset Support", desc: "Drag and drop images, sticky notes, code blocks, and dividers onto the canvas." },
  { icon: LayoutPanelLeft, title: "Inspector Panel", desc: "Fine-tune every property â€” position, size, color, typography, and effects." },
];
