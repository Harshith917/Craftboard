        ...
        <div className="space-y-4">
          <div className="flex items-center gap-1 bg-muted rounded-xl p-1">
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg transition-all ${
                mode === "user" ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"
              }`}
            >
              <Search size={13} />
              Search user
          ...
          <div className="relative">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 text-sm border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent bg-card"
              />
              {searching && (
                ...
                >
                  {foundUsers.map((user) => {
                    ...
                    return (
                      ...
                      >
                        <div className="w-8 h-8 rounded-full bg-accent overflow-hidden flex items-center justify-center shrink-0">
                          {user.imageUrl ? (
                        ...
                        {!disabled && <Check size={14} className="text-muted-foreground/60 shrink-0" />}
                        {disabled && <Ban size={14} className="text-muted-foreground/60 shrink-0" />}
                      </button>
                    );
                  })}
                </div>
